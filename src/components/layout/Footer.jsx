...
function Footer() {
  ...
  const footerText = data?.general?.footerText || 'Full Stack Developer with expertise in React, TypeScript, and the MERN stack. I build scalable web applications with a focus on performance and user experience.';
  ...
  const linkedinUrl = data?.general?.linkedinUrl || 'https://linkedin.com/in/vibush01';
  const githubUrl = data?.general?.githubUrl || 'https://github.com/Vibush01';
  const twitterUrl = data?.general?.twitterUrl || 'https://twitter.com/vibush01';
  const whatsappUrl = data?.general?.whatsappUrl || 'https://wa.me/917018235639';
