      ...
      <div className="max-w-6xl mx-auto px-6 py-20 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className={`text-lg md:text-xl max-w-2xl mx-auto mb-8 leading-relaxed ${
            ...
            Full Stack Developer with expertise in React 19, TypeScript, Hono, and the MERN stack. 
            I build scalable web applications, real-time systems, and browser extensions with a focus 
