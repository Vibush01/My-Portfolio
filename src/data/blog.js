...
export const blogPosts = [
  {
    ...
    date: 'Dec 28, 2025',
    readTime: '8 min read',
    image: '/images/blog/reactblog.webp',
    emoji: '⚛️',
    color: '#61dafb',
    colorEnd: '#21a1f1',
    featured: true
  },
  {
    ...
    title: 'Hono vs. Express: Is the King Finally Dethroned?',
    ...
    date: 'Dec 20, 2025',
    readTime: '6 min read',
    image: '/images/blog/honovsexpress.webp',
    emoji: '🔥',
    color: '#ff6b35',
    colorEnd: '#f7931e',
    featured: true
  },
  {
    ...
    image: '/images/blog/jwtblog.webp',
    emoji: '🔐',
    color: '#6366f1',
    colorEnd: '#8b5cf6',
    featured: true
  ...
  {
    id: 4,
    slug: 'gridstack-dashboard-guide',
    title: 'Building Customizable Dashboards with Gridstack.js',
    excerpt: 'Learn how to create drag-and-drop dashboard interfaces with resizable widgets using Gridstack.js and React.',
    category: 'Tutorial',
    date: 'Dec 10, 2025',
